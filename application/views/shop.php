...
<img    src="<?php echo base_url(); ?>assets/uploads/images_productos/<?= $shopp->imagen; ?> " class="img-thumbnail"   style="height:300px; width:200px">
             <font color=black><h4 style="min-height:45px;margin:5px   0   10px    0"> <?= $shopp->nombre; ?></font>
<font color=blue><h4 style="min-height:45px;margin:5px   0   10px    0"> <?= $shopp->precio; ?></font>
